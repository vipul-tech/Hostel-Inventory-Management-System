...
.footer {
   ...
   text-align: center;
	...
	<div class="hostel">
	<h1 style="text-align:center;color:orange;">Aryabhata Hall of Residence (Boys Hostel-IV)</h1>
	<img class="i1" src="Hostel 3.png" style="width:50%";>
	
	<p>The <i>Aryabhata Hall of Residence</i> i.e <i>Boys Hostel-IV</i> is located outside the campus.<p>
	<p>It comprises of 5 floors.</p>
	<p>It has capacity of 49 students.</p>
	<p>Number of single room=20<p>
	<p>Number of double room=10<p>
	<p>Number of triple room=3<p>
	<p>Warden:Dr.Dheeraj Kumar Sinha</p>
    ...
    <div id="id03" class="modal">
        ...
        window.onclick = function(event) {
          ...
          <div class="container">
              ...
              <input type="hidden" value="Aryabhata Hall of Residence (Boys Hostel-IV)" name="hostel" >
              <label for="uname"><b>Username</b></label>
              <input type="text" placeholder="Enter Username" name="uname" required>
              <label for="psw"><b>Password</b></label>
              <input type="password" placeholder="Enter Password" name="psw" required>

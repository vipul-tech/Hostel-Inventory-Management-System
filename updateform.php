...
.footer {
   ...
   text-align: center;
	...
	<div class="ul">
        ...
        <li><a href="updateform.php" class="active">Update Items</a></li>        
  ...
  <tr>
   ...
   ?>
   <tr>
    <td><input type="hidden" name="sno<?php echo $i; ?>" value="<?php echo $row['sno']; ?>" /></td> 
    <td><input type="text" name="item<?php echo $i; ?>" value="<?php echo $row['item']; ?>" /></td>
    <td><input type="text" name="order_date<?php echo $i; ?>" value="<?php echo $row['order_date']; ?>" /></td>
    <td><input type="text" name="received<?php echo $i; ?>" value="<?php echo $row['received']; ?>" /></td>
    ...
    <td><input type="text" name="total<?php echo $i; ?>" value="<?php echo $row['total']; ?>" /></td>
   ...
   ?>
    <tr>
    <td colspan=8 style="background-size:10px; text-align:center"><input type="submit" value='Update' /></td>
  </tr>
    </table>
</form>
    </div>

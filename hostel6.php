...
.footer {
   ...
   text-align: center;
	...
	<div class="hostel">
	<h1 style="text-align:center;color:orange;">Ganga Hall of Residence (Girls Hostel)</h1>
	<img class="i1" src="girlshostel.jpg" style="width:50%";>
	
	<p>The <i>Ganga Hall of Residence </i> i.e <i>Girls Hostel</i> is located inside the campus.<p>
	<p>It comprises of 2 floors.</p>
	<p>It has capacity of 20 students.</p>
	<p>Number of single room=0<p>
	<p>Number of double room=10<p>
	<p>Number of triple room=0<p>
	<p>Warden:Dr.Thejaswini M</p>
	<p>Caretaker:Mrs.XYZ</p>
	<br>
	<h3><p>Login for Warden</p>
	<p>And</p>
	<p>Caretaker</p></h3>
	<button onclick="document.getElementById('id03').style.display='block'" class="button" type="submit"href="#"  style="cursor:pointer;">Login</button>
  <div id="id03" class="modal">
        ...
        window.onclick = function(event) {
          ...
          <div class="container">
              ...
              <input type="hidden" value="Ganga Hall of Residence (Girls Hostel)" name="hostel" >
              <label for="uname"><b>Username</b></label>
              <input type="text" placeholder="Enter Username" name="uname" required>
              <label for="psw"><b>Password</b></label>
              <input type="password" placeholder="Enter Password" name="psw" required>

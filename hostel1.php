...
.footer {
   ...
   text-align: center;
	...
	<div class="hostel">
	<h1 style="text-align:center;color:orange;">Chanakya Hall of Residence (Boys Hostel-I)</h1>
	<img class="i1" src="hoste 1.png" style="width:50%";>
	
	<p>The <i>Chanakya Hall of Residence</i> i.e <i>Boys Hostel-I</i> is located inside the campus.<p>
	<p>It comprises of 4 floors.</p>
	<p>It has capacity of 100 students.</p>
	<p>Number of single room=0<p>
	<p>Number of double room=32<p>
	<p>Number of triple room=2<p>
	<p>Warden:Dr.Hiranmoy Pal</p>
	<p>Caretaker:Mr.Naveen</p>
	<br>
  ...
  <div id="id03" class="modal">
        ...
        window.onclick = function(event) {
          ...
          <div class="container">
              ...
              <input type="hidden" value="Chanakya Hall of Residence (Boys Hostel-I)" name="hostel" >
              <label for="uname"><b>Username</b></label>
              <input type="text" placeholder="Enter Username" name="uname" required>
              <label for="psw"><b>Password</b></label>
              <input type="password" placeholder="Enter Password" name="psw" required>

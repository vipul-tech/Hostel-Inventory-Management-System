...
.footer {
   ...
   text-align: center;
	...
	<div class="ul">
        ...
        <li><a href="deleteform.php" class="active">Delete Items</a></li>
  ...
  <tr>
   ...
   <tr>
    ...
    <td><input type="checkbox" value="<?php echo $row['sno']; ?>" name="b<?php echo $i; ?>" /></td>
	</tr>
    <?php
    }
    ?>
    <tr>
   <td colspan=9 style=" text-align:center"><input type="submit" name='delete' value='Delete' /></td>
    </tr>
    </table>
   </form></br>
    </div>

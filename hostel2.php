...
.footer {
   ...
   text-align: center;
	...
	<div class="hostel">
	<h1 style="text-align:center;color:orange;"> Chandragupta Hall of Residence (Boys Hostel-II)</h1>
	<img class="i1" src="IM2.jpg" style="width:50%";>
	
	<p>The <i>Chandragupta Hall of Residence</i> i.e <i>Boys Hostel-II</i> is located outside the campus.<p>
	<p>It comprises of 4 floors.</p>
	<p>It has capacity of 64 students.</p>
	<p>Number of single room=0<p>
	<p>Number of double room=32<p>
	<p>Number of triple room=0<p>
	<p>Warden:Dr.Pradeep Kumar Biswal</p>
    ...
    <div id="id03" class="modal">
        ...
        window.onclick = function(event) {
          ...
          <div class="container">
              ...
              <input type="hidden" value=" Chandragupta Hall of Residence (Boys Hostel-II)" name="hostel" >
              <label for="uname"><b>Username</b></label>
              <input type="text" placeholder="Enter Username" name="uname" required>
              <label for="psw"><b>Password</b></label>
              <input type="password" placeholder="Enter Password" name="psw" required>

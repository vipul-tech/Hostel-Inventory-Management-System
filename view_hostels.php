...
$con=mysqli_connect('localhost','root');
	...
	$q="select * from inventory where hostel='$hostel'";
   ...
   text-align: center;
	...
	<div class="ul">
		...
		<div class="column">
			...
			<ul>
				<li><a href="hostels.php"
					>Change password</a></li>
				<li><a href="view_hostels.php"  class="active">View Items</a></li>
     ...
     <table id="view_table" style="border-color:black; border-style:solid; background-color: #4CAF50; text-align:center; width:90%; border-radius:18px; box-sizing:border-box; margin:0 0 0 100px;"> 
  <tr>
    <th>Serial No</th>
    <th>Item</th>
    <th>Order Date</th>
